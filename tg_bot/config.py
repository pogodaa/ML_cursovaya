...
BASE_DIR = os.path.dirname(os.path.abspath(__file__))  # ИСПРАВЛЕНО
FEATURE_NAMES_PATH = os.path.join(BASE_DIR, 'models', 'feature_names.json')
MODEL_PATHS = {
    'lightgbm': os.path.join(BASE_DIR, 'models', 'lightgbm_best_model.pkl')  # ИСПРАВЛЕНО имя
}

print("✅ Конфигурация загружена. Токен:", BOT_TOKEN[:5] + "...")