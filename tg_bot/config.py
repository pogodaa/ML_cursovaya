...
# Пути к моделям - ИСПРАВЛЕННЫЕ ПУТИ
BASE_DIR = os.path.dirname(os.path.abspath(__file__))  # ИСПРАВЛЕНО: правильный базовый путь
FEATURE_NAMES_PATH = os.path.join(BASE_DIR, 'models', 'feature_names.json')
MODEL_PATHS = {
    'lightgbm': os.path.join(BASE_DIR, 'models', 'best_model_lightgbm.pkl')  # ИСПРАВЛЕНО имя файла
}
